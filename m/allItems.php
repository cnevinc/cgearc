...
我想要找:<BR>
<a href="?clause=Hat">[帽子]</a>&nbsp;<a href="?clause=Shirt">[上衣]</a>&nbsp;<a href="?clause=Jacket">[外套]</a>&nbsp;<a href="?clause=base">[內層]</a>&nbsp;<BR>
<a href="?clause=Pants">[褲]</a>&nbsp;
<a href="?clause=Socks">[襪]</a>&nbsp;&nbsp;<a href="?clause=Boots">[靴]</a>&nbsp;<a href="?clause=Shoes">[鞋]</a>&nbsp;<BR>
<a href="?clause=Backpack">[包]</a>&nbsp;<a href="?clause=Gore">[Gore-Tex®]</a>&nbsp; <a href="?clause=Soft%20Shell">[Soft Shell]</a>&nbsp; <a href="?clause=Hardwear">[Mountain Hardwea]</a>&nbsp; <a href="?clause=Sleeping">[睡袋]</a>&nbsp; 
 <BR>
<a href="?clause=">[都看看]</a>&nbsp;  
...
<table border=1>
 ...
 <?PHP
	...
	while($row = mysql_fetch_array($result)) {
		$i++;
		echo "<tr>";
		echo "<td><input type=checkbox name=refLine_id[] value=".$row["line_id"].">";
		echo "</td>";
		echo "<td><a href='".$row["stp_url"]."' target=blank>連結</a></td>";
